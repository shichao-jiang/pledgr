  ...
  import { contributeToCampaign } from "./HandleContributions"
    ...
    return (
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="flex flex-col">
          ...
          {amount !== "" && Number(amount) <= 0 && (
            <p className="text-sm text-red-500 mt-1">Enter a positive amount</p>
          )}
        </div>
      ...
      <Button
          ...
          const transaction:InputTransactionData = {
              data: {
                function: "0xe772c372ec3ec4540bc592f75e689a72552987616255e731fdbe52cb713cf832::campaign_manager::contribute_to_campaign",
                typeArguments: ["0x1::aptos_coin::AptosCoin"], // Specify the CoinType here
                functionArguments:[campaign.recipientAddress, campaign.campaign_num, 0],
              }
            }
          try {
